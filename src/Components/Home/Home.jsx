                        ...
                        <NavLink to={`/home/${data.id}`} key={data.id} className={{}} >
                           ...
                           <img className="w-full h-56" src={data.img} />
                            <div className="text-left p-4">
                                ...
                                <h2 style={{color:data.bg_color.text_color}} className="text-3xl font-semibold ">{data.title}</h2>                                                                
                            </div>
                        </div>      
                        </NavLink>               
                    ))
